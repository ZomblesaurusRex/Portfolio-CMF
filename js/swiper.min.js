...
!(function(e, t) {
  ...
  var o = {
    ...
    on: function() {
      ...
      if ("function" == typeof s[1]) {
        var c;
        (n = (c = s)[0]), (l = c[1]), (d = c[2]), (o = void 0);
      }
      d || (d = !1);
      for (var p, u = n.split(" "), h = 0; h < this.length; h += 1) {
        var v = i[h];
        if (o)
          ...
          if (s) {
            if (p.dom7LiveListeners)
              for (var u = 0; u < p.dom7LiveListeners.length; u += 1)
                r
                  ? p.dom7LiveListeners[u].listener === r &&
  ...
  var l = {
    ...
    d = {
      touch:
        ...
        !!(
          "ontouchstart" in r ||
          (r.DocumentTouch && document instanceof r.DocumentTouch)
        ),
      transforms3d:
  ...
  var u = {
        ...
        if (void 0 !== i) {
          ...
          if (
            ...
            for (var D = 0; D < c.length; D += 1)
              c[D] < e.virtualSize + c[0] && L.push(c[D]);
            c = L;
          }
          if (!t.centeredSlides) {
            L = [];
            for (var O = 0; O < c.length; O += 1)
              c[O] <= e.virtualSize - i && L.push(c[O]);
            (c = L),
              Math.floor(e.virtualSize - i) - Math.floor(c[c.length - 1]) > 1 &&
                c.push(e.virtualSize - i);
          }
          0 === c.length && (c = [0]),
            0 !== t.spaceBetween &&
              (e.isHorizontal()
      ...
      updateActiveIndex: function(e) {
        ...
        if (
          ((t = Math.floor(c / n.slidesPerGroup)) >= r.length &&
            (t = r.length - 1),
          c !== o)
        ) {
          var u = parseInt(
    ...
    h = {
      ...
      setTranslate: function(e, t) {
        ...
        (0 === c ? 0 : (e - a.minTranslate()) / c) !== n && a.updateProgress(e),
    ...
    f = (function() {
      return {
        ...
        ieTouch:
          (r.navigator.msPointerEnabled && r.navigator.msMaxTouchPoints > 1) ||
          (r.navigator.pointerEnabled && r.navigator.maxTouchPoints > 1),
        lteIE9: (function() {
        ...
        return !(
          ...
          (p && -v === s.translate) || (!p && v === s.translate)
            ...
            : (s.updateSlidesClasses(),
              ...
              s.transitionStart(a),
              0 === t || f.lteIE9
                ? (s.setTransition(0), s.setTranslate(v), s.transitionEnd(a))
                : (s.setTransition(t),
                  s.setTranslate(v),
                  s.animating ||
                    ((s.animating = !0),
      ...
      loopCreate: function() {
        ...
        if (a.loopFillGroupWithBlank) {
          ...
          if (r !== a.slidesPerGroup) {
            for (var n = 0; n < r; n += 1) {
              var o = e(document.createElement("div")).addClass(
      ...
      if (
        ...
        if (s.noSwiping && e(n).closest("." + s.noSwipingClass)[0])
          ...
          var o = r.currentX,
            d = r.currentY;
          if (
            !(y.ios && s.iOSEdgeSwipeDetection && o <= s.iOSEdgeSwipeThreshold)
          ) {
            if (
              (l.extend(i, {
                isTouched: !0,
              ...
              e(n.target).is(i.formElements) && (c = !1),
                document.activeElement &&
                  e(document.activeElement).is(i.formElements) &&
      ...
      if (
        ...
        if (!a.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (l.extend(r, { startX: d, startY: c, currentX: d, currentY: c }),
              (i.touchStartTime = l.now()))
            )
          );
          ...
          if (
            ...
            if (i.isScrolling) i.isTouched = !1;
              ...
              if (
                ...
                u > 0 && i.currentTranslate > a.minTranslate()
                  ? ((h = !1),
                    s.resistance &&
                      (i.currentTranslate =
                        a.minTranslate() -
                        1 +
                        Math.pow(-a.minTranslate() + i.startTranslate + u, v)))
                  : u < 0 &&
                    ...
                    s.resistance &&
                      (i.currentTranslate =
                        a.maxTranslate() +
                        1 -
                        Math.pow(a.maxTranslate() - i.startTranslate - u, v))),
        ...
        attachEvents: function() {
          ...
          if (f.ie)
            r.addEventListener(a.start, e.onTouchStart, !1),
              (d.touch ? r : document).addEventListener(
                a.move,
                e.onTouchMove,
                n
              ),
        ...
        detachEvents: function() {
          ...
          if (f.ie)
            r.removeEventListener(a.start, e.onTouchStart, !1),
              (d.touch ? r : document).removeEventListener(
                a.move,
                e.onTouchMove,
                n
              ),
      ...
      classes: {
        addClasses: function() {
          ...
          n.push(a.direction),
            ...
            y.ios && n.push("ios"),
            (r.navigator.pointerEnabled || r.navigator.msPointerEnabled) &&
    ...
    k = (function(t) {
      function a() {
        ...
        p.useModulesParams(u),
          (p.params = l.extend({}, u, P, o)),
          (p.originalParams = l.extend({}, p.params)),
          (p.passedParams = l.extend({}, o));
        var h = e(p.params.el);
        if ((n = h[0])) {
          if (h.length > 1) {
            var v = [];
          ...
          (n.swiper = p), h.data("swiper", p);
          var f = h.children("." + p.params.wrapperClass);
          return (
            l.extend(p, {
              $el: h,
              el: n,
              ...
              touchEvents: (function() {
                ...
                return (
                  ...
                  {
                    start: d.touch || !p.params.simulateTouch ? e[0] : t[0],
                    move: d.touch || !p.params.simulateTouch ? e[1] : t[1],
                    end: d.touch || !p.params.simulateTouch ? e[2] : t[2]
                  }
                );
              })(),
              touchEventsData: {
        ...
        (a.prototype.slidesPerViewDynamic = function() {
          ...
          if (t.centeredSlides) {
            ...
            for (var c = r - 1; c >= 0; c -= 1)
              a[c] &&
                !o &&
                ((n += 1), (l += a[c].swiperSlideSize) > s && (o = !0));
          } else
            for (var p = r + 1; p < a.length; p += 1)
              i[p] - i[r] < s && (n += 1);
          return n;
        }),
    ...
    L = { name: "browser", proto: { browser: f }, static: { browser: f } },
    D = {
      name: "resize",
      create: function() {
        var e = this;
        ...
        if (a.params.virtual.renderExternal)
          return (
            a.params.virtual.renderExternal.call(a, {
              ...
              to: y,
              slides: (function() {
                for (var e = [], t = w; t <= y; t += 1) e.push(p[t]);
                return e;
              })()
            }),
            void t()
      ...
      on: {
        beforeInit: function() {
          ...
          e.params.virtual.enabled &&
            ...
            l.extend(e.params, { watchSlidesProgress: !0 }),
            e.virtual.update());
        },
    ...
    Y = {
        ...
        if (
          ...
          if (37 === i || 39 === i || 38 === i || 40 === i) {
            ...
            if (
              ...
              return;
            var n = { left: r.pageXOffset, top: r.pageYOffset },
              o = r.innerWidth,
              l = r.innerHeight,
              d = t.$el.offset();
      ...
      enable: function() {
        var t = this;
        t.keyboard.enabled ||
          (e(document).on("keydown", t.keyboard.handle),
          (t.keyboard.enabled = !0));
      },
      disable: function() {
        var t = this;
        t.keyboard.enabled &&
          (e(document).off("keydown", t.keyboard.handle),
          ...
          if (
            (t.params.loop
              ? ((i = Math.ceil(
                  ...
                  s - 1 - 2 * t.loopedSlides && (i -= s - 2 * t.loopedSlides),
                i > n - 1 && (i -= n),
                i < 0 && "bullets" !== t.params.paginationType && (i = n + i))
              : (i = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0),
            "bullets" === a.type &&
            ...
            if (a.dynamicBullets) {
              var d =
                (5 * t.pagination.bulletSize - t.pagination.bulletSize) / 2 -
                i * t.pagination.bulletSize;
              o.css(t.isHorizontal() ? "left" : "top", d + "px");
            }
          }
          if (
            ("fraction" === a.type &&
              (r.find("." + a.currentClass).text(i + 1),
        ...
        if (t.params.scrollbar.el) {
          ...
          0 === o.length &&
            ...
            (t.scrollbar.dragEvents =
              !1 !== t.params.simulateTouch || d.touch
                ? s
    ...
    K = {
      setTransform: function(t, a) {
        ...
        if (
          ...
          "undefined" != typeof pOpacity && null !== p)
        ) {
          var u = p - (p - 1) * (1 - Math.abs(a));
          r[0].style.opacity = u;
        }
        if ("undefined" == typeof pScale || null === c)
    ...
    _ = {
      ...
      in: function(t) {
        ...
        if (
          ...
          var o, l, d, c, p, u, h, v, f, m, g, b, w, y, x, T;
      ...
      load: function() {
        ...
        if (n.loadPrevNext)
          if (o > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            for (
              var d = n.loadPrevNextAmount,
                c = o,
                p = Math.min(r + c + Math.max(d, c), s.length),
                u = Math.max(r - Math.max(c, d), 0),
                h = r + o;
              h < p;
              h += 1
            )
    ...
    ne = {
      ...
      destroy: function() {
        var t = this;
        t.params.hashNavigation.watchState &&
          e(r).off("hashchange", t.hashNavigation.onHashCange);
      }
    },
    oe = {
    ...
    me = {
      setTranslate: function() {
        ...
        f.ie && (r[0].style.perspectiveOrigin = c + "px 50%");
      },
      setTransition: function(e) {
        this.slides
          .transition(e)
